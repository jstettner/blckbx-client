    ...
    return(
      <div>
        <Jumbotron className="mtl mbl">
          ...
          <h4>Now it's easy to distribute simple utility algorithms and much more. Head on over to the <Link to="/instructions" className="deep-sea">Help</Link> section for more info and program ideas.</h4>
