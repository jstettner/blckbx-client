    ...
    return(
      <div>
        <Jumbotron className="mtl mbl">
          ...
          <h4>The process of distributing text based programs has been streamlined. Head on over to the <Link to="/instructions" className="deep-sea">Help</Link> section for more info and program ideas.</h4>
